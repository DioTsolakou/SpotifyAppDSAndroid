...
{
    private ArrayList<String> findArtistSongs(String artistName) {
        ArrayList<String> songs = new ArrayList<>();
        String dir, artist, title;
        if(Character.toUpperCase(artistName.charAt(0)) <= 'K') dir = "spotifyPackage\\Publisher\\A-K";
    ...
    private ArrayList<String> findAllArtists() {
    ...
    private ArrayList<String> findArtists(String dir) {
